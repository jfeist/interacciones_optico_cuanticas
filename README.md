...
**Cons:** Available computing power is extremely limited: for numerical simulations, Binder is often orders of magnitude slower than GitHub Codespaces or running locally on your own computer. 
Furthermore, the session shuts down automatically after about 10 minutes of inactivity, and any changes you make (edited notebooks, saved results) are lost when it does — the environment is completely temporary.

## Option 2 — GitHub Codespaces (persistent, GitHub account required)

Go to the repository page on GitHub and click **Code → Codespaces → Create codespace on main**. VS Code will open in your browser with everything already installed, running in a virtual machine in the cloud.

**Pros:** Your work is saved between sessions. Fast to start since it is set up with a pre-built image.  
**Cons:** Requires a free GitHub account.

GitHub's free tier includes 60 hours/month of Codespace usage, which should be plenty for this course. Furthermore, as a student, you can get a "Pro" account for free, see https://github.com/education/students.
